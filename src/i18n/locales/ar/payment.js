export default {
  ...
  loadingParagraph:
    "جار تحميل طريقة الدفع , برجاء الانتظار . قد يستغرق هذا مايصل الى ١٥ ثانية",
  orderPlaced: "تم تسجيل طلبك بنجاح",
  checkCachResult:
    "سيتم تحويلك تلقائيا الى طلبك , برجاء الانتظار قد يستغرق هذا مايصل الى ١٥ ثانية",
  checkBankResult:
    "سيتم تحويلك تلقائيا الى صفحة تأكيد عملية التحويل البنكى , برجاء الانتظار قد يستغرق هذا مايصل الى ١٥ ثانية",
