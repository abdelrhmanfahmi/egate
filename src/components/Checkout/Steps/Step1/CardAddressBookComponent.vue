    ...
    <div class="checkoutComponent">
        <div class="form-holder">
            <v-card class="mx-auto styleCardAddress" elevation="4">
                <v-card-item>
                    <v-card-title>
                        <p>Pick Address Book</p>
                    </v-card-title>
                </v-card-item>

                <v-card-text v-if="addressBooks.length > 0">
                    <div class="d-flex" v-for="(addressBook, idx) in addressBooks" :key="idx">
                        <div>
                            <input type="radio" :value="addressBook.id" @change="undisableCheckout"
                                v-model="orderCheckout.address_book_id" />
                        </div>
                        &nbsp;&nbsp;
                        <div>
