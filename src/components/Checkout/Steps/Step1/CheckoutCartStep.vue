        ...
        <div class="form-holder">
          ...
          <v-row class="mt-11">
            ...
            <v-col cols="12" md="6" sm="12" class="text-black">
              <v-btn class="bg-main text-black" @click="changeActiveStep(2)"
                >Continue To Checkout <v-icon icon="mdi-chevron-right"></v-icon
              ></v-btn>
            </v-col>
          </v-row>
        </div>
