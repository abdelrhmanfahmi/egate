        ...
        <div class="cartSideMenu" :class="{ sideOpened: sideVisible, sideClosed: !sideVisible }">
            ...
            <div class="profile">
                ...
                <form>
                    ...
                    <v-text-field v-model.trim="form.password" label="Password" autocomplete="new-password" required
                        :rules="repeatPasswordRules" :append-inner-icon="show2 ? 'mdi-eye' : 'mdi-eye-off'"
                    ...
                    <button class="buy-btn" @click="login">
                        SIGN IN
                    </button>
