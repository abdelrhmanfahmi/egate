<template>
    <div class="login-tabs">
        <div class="user-login">
            <b-sidebar id="login" backdrop width="450px" :right="getDir === 'rtl'" shadow z-index="5"
                body-class="sidebar-login" bg-variant="#fff">
                <template #default="{ hide }">
                    <div class="user-login-form">
                        <div class="">

                            <b-tabs >
                                <b-tab :title="$t('login.retailBuyer')" active>
                                    <B2cTab />
                                </b-tab>
                                <b-tab :title="$t('login.wholeSaleBuyer')">
                        ...
                        <div class="row flex-row justify-content-between align-items-center mb-4 text-dark">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <a href="https://staging2.fabrica-dev.com/humhum-supplier/" target="_blank"
                                    class="text-dark font-weight-bold text-decoration-underline">{{ $t("home.suppliers")
                                    }}</a>
                            </div>
                        </div>
                        ...
                        <form @submit.prevent="loginB2c()">
                            ...
                            <div class="show-password">
                                ...
                                <div class="error text-start" v-for="(error, index) in errorsLogin.password"
                                    :key="index">
                                    {{ error }}
                                </div>
                                <div class="icon-passowrd" @click="switchField()">
                                    <font-awesome-icon icon="fa-solid fa-eye" v-if="fieldType === 'password'"
                                        size="lg" />
            ...
            <b-modal id="ForgetPassword" :title="$t('login.resetPassword')" no-close-on-backdrop no-close-on-esc
                ref="b2cLogin">
                <form>
                    <b-form-group>
...
import B2cTab from "../loginTabs/B2cTab.vue"
