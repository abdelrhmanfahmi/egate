        ...
        <div class="d-flex float-right px-5 pb-5" v-if="ordersLength > 0">
          ...
          <div class="" v-if="checkedProduct && checkedProduct.length > 0">
            <b-button
              ...
              class="mx-2"
              @click="removeCheckedProductFromCart"
            >
                  ...
                  <tr v-if="item.product_supplier">
                    <td class="text-center">
                      ...
                      >
                        <input
                          ...
                          :value="item.product_supplier.id"
                    ...
                    <td class="text-center">
                      <Variants-Counter
                        ...
                        @changeCount="ChangeCounter($event, item)"
                      ></Variants-Counter>
                    </td>
                    <td class="text-center">
                      <p
  ...
  methods: {
    ...
    addToCart(item) {
      let data = {
        ...
        quantity: this.cartCounter ? this.cartCounter : 1,
