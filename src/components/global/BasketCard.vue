<template>
    <div class="product-cart">
      <small class="ribbon ribbon-top-left" :class="{'long-rebbon':dealType.trim().length > 20}"  v-if="dealType"><span :class="{'long-rebbon-span':dealType.trim().length > 20}">{{dealType}}</span></small>
      <div v-if="slider">
        <router-link
          class="img-holder"
