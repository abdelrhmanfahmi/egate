<template>
    <div class="product-silder pt-5">
        ...
        <div class="suppliers pt-2" v-if="clients">
            ...
            <VueSlickCarousel v-bind="settings" v-if="!loading && clients && clients.length">
                <div v-for="(client, index) in clients" :key="index">
                    <div class="d-flex justify-content-center align-items-center text-center">
                        <div class="d-flex justify-content-center align-items-center text-center" v-if="client.image_path">
                            <b-img :src="client.image_path" class="supplier-image" alt="client image">
                            </b-img>
                        </div>
                        <div class="supplier-image" v-else>
                            <img :src="logoEnv" v-if="logoEnv" class="img-fluid upplier-image" alt="client image" />
                        </div>
                    </div>
                    <!-- <div>
                        <h6>{{ client.name }}</h6>
