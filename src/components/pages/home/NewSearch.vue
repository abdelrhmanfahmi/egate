            ...
            <div class="new-search-design w-100">
                <div class="search-local">
                    <div class="iconn bottom-nav-holder">
                        <div class="wrapper select-wrapper">
                            <div class="data-wrapper d-flex justify0content-center align-items-center">
                                <div class="grid-icon">
                                    <font-awesome-icon icon="fa-solid fa-table-cells-large" size="xl" class="text-dark" />
                                </div>
                    ...
                    <div class="form-holder w-100 m-0 p-0">
                        <b-form @submit.prevent="search" @keyup="search(); searchSubmitted = true" class="w-100 m-0 p-0">
                            <b-form-input :placeholder="$t('cart.search')" class="search-input w-100 m-0 p-0"
                                v-model="keyword" ref="searchIcon"></b-form-input>
                        ...
                        <div v-else-if="!suggestionsExist && searchSubmitted == true && keyword.length">
