  ...
  <header class="header-style-five header-style-eight">
        ...
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-sm-6">
            <div class="header-top-right">
              ...
              <li class="country-switch">
                <button
                  class="hd-country switch"
                  type="button"
                  id="website-dropdown"
                  data-toggle="dropdown"
                  aria-haspopup="true"
                  aria-expanded="false"
                  style="background: #202026; border: #20202600; color: #fff"
                >
                  <div style="display: inline-block"></div>
                  <span class="xc-white-font">
                    الكويت<img
                      src="https://www.countryflags.io/kw/flat/16.png"
                      alt="1"
                  /></span>
                </button>

                <ul
                  class="hd-country-menu dropdown-menu"
                  aria-labelledby="website-dropdown"
                >
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/kw/flat/32.png"
                        alt="1"
                      />الكويت</a
                    >
                  </li>
                  ...
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/ae/flat/32.png"
                        alt="3"
                      />الإمارات</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/qa/flat/32.png"
                        alt="4"
                      />قطر</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/om/flat/32.png"
                        alt="5"
                      />عمان</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/bh/flat/32.png"
                        alt="6"
                      />البحرين</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/eg/flat/32.png"
                        alt="7"
                      />مصر</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/iq/flat/32.png"
                        alt="8"
                      />العراق</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/jo/flat/32.png"
                        alt="9"
                      />الأردن</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/lb/flat/32.png"
                        alt="10"
                      />لبنان</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/ye/flat/32.png"
                        alt="11"
                      />اليمن</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/sy/flat/32.png"
                        alt="12"
                      />سوريا</a
                    >
                  </li>
                  <li>
                    <a class="nav-sub-item" href="#"
                      ><img
                        src="https://www.countryflags.io/ps/flat/32.png"
                        alt="13"
                      />فلسطين</a
                    >
                  </li>
              ...
              <li class="nav-item dropdown country-switch">
                <button
                  class="hd-country switch"
                  type="button"
                  id="website-dropdown"
    ...
    <div id="sticky-header" class="main-header menu-area">
      <div class="container custom-container-two">
        <div class="row">
          <div class="col-12">
            <div class="mobile-nav-toggler">  <font-awesome-icon :icon="['fas', 'fa-bars']" class="icon alt"/>
</div>
            <div class="menu-wrap">
                  ...
                  <ul class="navigation right">
                    ...
                    <li class="menu-item-has-children">
                      ...
                      <ul class="submenu">
                        ...
                        <li>
                          <a href="B2Cbuyer.html" target="_blank">مشتري </a>
                        </li>
                      </ul>
                    </li>
...
<span>0</span></a
                      ...
                      <ul class="minicart">
                        ...
                        <li>
                          <div class="total-price">
                            <span class="f-right">الاجمالي</span>
                            <span class="f-left">8.600kd</span>
                          </div>
                        </li>
                        <li>
                    ...
                    <li class="sidebar-toggle-btn">
                      <a href="" class="navSidebar-button"
                        ...
                        <h5><small>تسجيل دخول</small></h5></a
                      >
                    </li>
                  </ul>
                </div>
              ...
              <nav class="menu-box">
                ...
                <div class="menu-outer">
                  <ul class="navigation">
                    ...
                    <li><a href="suppliers.html">الموردين</a></li>
                    <li><a href="about-us.html">عن الشركة</a></li>
                    <li><a href="singup.html">تسجيل الشركات</a></li>
                    <li><a href="singup.html">تسجيل مشتري</a></li>
                    <li><a href="contact.html">اتصل بنا</a></li>
                    <li><a href="contact.html">الدعم</a></li>
                    <li><a href="#">الشروط و الاحكام</a></li>
                    <li><a href="#">الاسئلة الشائعة</a></li>
                    <li><a href="about-us.html">المساعدة</a></li>
                    <li><a href="contact.html">معلومات</a></li>
                  </ul>
                </div>
    ...
    >
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form>
            <a href="items.html"><input type="text" placeholder="ابحث" /></a>
            ...
            <div class="sidebar-info-contents">
              <div class="content-inner">
                <div class="oc-newsletter">
                  ...
                  <form action="#">
                    <input type="email" placeholder="كلمة المرور..." />
                    <button class="btn">
                      <a href="indexlogin.html">تسجيل الدخول</a>
                    </button>
                  </form>
                </div>
                <br />
                <div class="oc2-social">
                  <p>الدخول للاشخاص</p>
                  <ul>
                    <li class="btnf">
                ...
                <div class="oc-newsletter">
                  ...
                  <form action="#">
                    <button class="btn">
                      <a href="B2Cbuyer.html">تسجيل حساب</a>
                    </button>
                  </form>
                </div>
              </div>
...
.of-canvas-heading .close-side-widget:hover,
.sidebar-of-canvas .contact-info ul li span,
.sidebar-of-canvas .contact-info ul li a:hover,
...
.btng {
  -moz-user-select: none;
  background: #c5221f none repeat scroll 0 0;
  border: medium none;
  border-radius: 0;
  color: #c5221f;
  display: inline-block;
...
.sa:before {
  background-image: url(https://www.countryflags.io/sa/flat/32.png);
}
...
.qa:before {
  background-image: url(https://www.countryflags.io/qa/flat/32.png);
}

.om:before {
  background-image: url(https://www.countryflags.io/om/flat/32.png);
}
.bh:before {
  background-image: url(https://www.countryflags.io/bh/flat/32.png);
}
...
.iq:before {
  background-image: url(https://www.countryflags.io/iq/flat/32.png);
}

.jo:before {
  background-image: url(https://www.countryflags.io/jo/flat/32.png);
}

.lb:before {
  background-image: url(https://www.countryflags.io/lb/flat/32.png);
}

.ye:before {
  background-image: url(https://www.countryflags.io/ye/flat/32.png);
}

.sy:before {
  background-image: url(https://www.countryflags.io/sy/flat/32.png);
}

.ps:before {
  background-image: url(https://www.countryflags.io/ps/flat/32.png);
}
...
.story-container ul li.has-story .story {
  padding: 0px;
  background: linear-gradient(148deg, #1570b1 25%, #ed212400 100%);
}
...
.story-container.discount-end-time-wrap {
  text-align: center;
  margin-left: 80px;
  background-position: center;
  background-size: cover;
...
.story-container.discount-end-time-wrap::before {
  content: "";
  position: absolute;
  left: 0;
  top: 0;
...
.story-container.discount-end-time-wrap::after {
  content: "";
  position: absolute;
  width: 100%;
  height: 100%;
...
.story-container.discount-end-time-wrap .icon {
  opacity: 0.4;
  margin-bottom: 20px;
}
.story-container.discount-end-time-wrap .content > span {
  color: #ed2124;
  font-size: 16px;
  text-transform: uppercase;
  font-weight: 400;
...
.story-container.discount-end-time-wrap .content h2 {
  font-size: 34px;
  color: #fff;
  margin-bottom: 20px;
  font-weight: 700;
...
.story-container.discount-end-time-wrap .coming-time {
  display: flex;
  align-items: center;
  justify-content: center;
  background: #fff;
...
.story-container.discount-end-time-wrap .coming-time div {
  padding: 0 15px;
  position: relative;
  font-size: 12px;
  color: #3262be;
...
.story-container.discount-end-time-wrap .coming-time div::after {
  content: ":";
  position: absolute;
  right: -1px;
  top: 50%;
...
.story-container.discount-end-time-wrap .coming-time div span {
  display: block;
  line-height: 1;
  font-size: 16px;
  font-weight: 700;
...
.story-container.discount-end-time-wrap .coming-time div:last-child:after {
  display: none;
}
...
.story-container.container h1 {
  text-transform: uppercase;
  font-size: 60px;
  margin: 0px;
  letter-spacing: 10px;
}
.story-container.container h2 {
  margin: 0;
  font-size: 20px;
  font-weight: 500;
  font-style: italic;
}
.story-container .count {
  margin: 7px 0;
}
.story-container .count span {
  display: revert;
  font-size: 14px;
  float: right;
}
.story-container .count p {
  display: revert;
  font-size: 10px;
  /* float: right; */
}

.story-container .countd {
  display: inline-block;
  width: 54px;
  height: 54px;
  /* border: 2px solid; */
...
#box1 {
  ...
  transform: transform 20s linear;
  transform: rotate(360deg);
}
#circle-timer {
  width: 10px;
  ...
  top: -2px;
  left: -1px;
  animation: do2 0.5s 19.9s forwards;
}
#box2 {
  right: 0;
  top: 0;
  transform-origin: top left;
  transform: transform 15s linear 5s;
...
#box3 {
  ...
  transform: transform 10s linear 10s;
  transform: rotate(180deg);
}
#box3 {
  right: 0;
  ...
  transform: transform 5s linear 15s;
  transform: rotate(90deg);
}
...
.slider-area position-relative .coming-time {
  display: flex;
  align-items: center;
  justify-content: center;
  background: #fff;
...
.slider-bottom-nav .coming-time div {
  padding: 0 15px;
  position: relative;
  font-size: 12px;
  color: #544842;
...
.slider-bottom-nav .coming-time div::after {
  content: ":";
  position: absolute;
  right: -1px;
  top: 50%;
...
.slider-bottom-nav .coming-time div span {
  display: block;
  line-height: 1;
  font-size: 16px;
  font-weight: 700;
...
.slider-bottom-nav .coming-time div:last-child:after {
  display: none;
}
...
.h7-slider-content .coming-time div {
  padding: 0 15px;
  position: relative;
  font-size: 12px;
  color: #544842;
...
.h7-slider-content .coming-time div::after {
  content: ":";
  position: absolute;
  right: -1px;
  top: 50%;
...
.h7-slider-content .coming-time div span {
  display: block;
  line-height: 1;
  font-size: 16px;
  font-weight: 700;
...
.h7-slider-content .coming-time div:last-child:after {
  display: none;
}
...
.cat-banner-item .thumb {
  text-align: center;
  margin-top: 25px;
  background: #fff;
}

.cat-banner-item .content-box {
  background: #ffffff99;
  position: absolute;
  left: 35px;
  bottom: 30px;
...
.new-arrival-item .thumb .discount-tag.size {
  background: #70b469;
}
...
@media screen and (max-width: 500px) {
  ...
  .items-table,
  .items-table .table table-bordered {
    text-align: center;
    margin-left: 0;
    margin-right: 239px;
    background-position: center;
  ...
  .items-table .table table-bordered > img {
    max-width: 100%;
  }
  .items-table .table,
  .additional-table .table th {
