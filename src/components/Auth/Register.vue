<template>
  <div class="register-wrapper profile">
    <div class="py-11">
      <h1 class="mb-8 text-center">Register</h1>
      <v-row>
          ...
          <div class="">
              ...
              <v-form @submit.prevent="register">
                ...
                <div class="mb-3">
                  ...
                  <span class="mb-3" v-if="AuthErrors">
                    <div
                      ...
                      v-for="(error, index) in AuthErrors.first_name"
                      :key="index"
                    >
                      {{ error }}
                    </div>
                ...
                <div class="mb-3">
                  ...
                  <span class="mb-3" v-if="AuthErrors">
                    <div
                      class="error text-red"
                      v-for="(error, index) in AuthErrors.last_name"
                      :key="index"
                    >
                      {{ error }}
                    </div>
                ...
                <div class="mb-3">
                  ...
                  <span class="mb-3" v-if="AuthErrors">
                    <div
                      class="error text-red"
                      v-for="(error, index) in AuthErrors.mobile"
                      :key="index"
                    >
                      {{ error }}
                    </div>
            ...
            <v-row class="my-4">
              <v-col cols="12" md="6" sm="12">
                <button class="buy-btn" @click="register">SIGN UP</button>
              </v-col>
              <v-col cols="12" md="6" sm="12" class="text-black">
                <button
                  class="view-btn border-gray color-gray"
                  @click="form = {}"
                >
                  CLEAR
                </button>
  ...
  methods: {
    ...
    register() {
      this.$store
        ...
        .then(() => {
          console.log("AuthErrors1", this.AuthErrors);
        })
        .catch((err) => {
